...
export * from './pages/HousePayment/component/HouseDetails';
export * from './elements/Input/Input';
export * from './pages/HousePayment/housePayment';
export * from './elements/Icons/SliderButton';
export * from './elements/Icons/CalenderIcon';
export * from './pages/HousePayment/component/HousePrice';
export * from './pages/HousePayment/component/slideImage';
